...
export const metadata: Metadata = {
  title: "Leave a Review | Los Angeles Fashion Consulting",
  description: "Leave Los Angeles Fashion Consulting a review on Google or Yelp.",
};

const reviews = [
  { label: "Leave a Google Review", href: "https://g.page/r/Cb65h3UCqnKwEBM/", kind: "google" },
];
    ...
    <section className="bg-white py-20 md:py-28">
      <div className="mx-auto max-w-2xl px-4 text-center">
        ...
        <p className="mb-10 text-gray-600">
          Your feedback helps others find Los Angeles Fashion Consulting and helps us keep improving.
        </p>
